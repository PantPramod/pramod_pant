      ...
      <div className="px-10">
        ...
        <div className="flex gap-15  flex-wrap mt-10 justify-between gap-y-20 items-stretch">
          ...
          <div className="mx-auto sm:mx-[unset] max-w-[300px] w-full sm:w-[45%] md:w-[30%] shadow-2xl rounded-xl overflow-hidden border border-gray-400 pb-2 bg-gray-200">
            ...
            />
            <p className="font-bold uppercase text-center mt-2">Utility App</p>
            <p className="text-gray-600 text-xs px-2 flex gap-x-2 font-bold mt-2">
              <span>Technology:</span>
              <span>  React JS , Node JS, Express JS, Puppeteer</span>
            </p>
            <div className="flex items-center justify-between px-2 pt-2 mt-2 mb-2">
              <a href="https://github.com/PantPramod/utility-app" target="_blank" className=" text-white border-2 w-[104px] flex items-center justify-center bg-blue-600 border-blue-600 hover:scale-105 transition-all ease-in-out duration-300 p-2  rounded-full  font-semibold text-center text-xs">Source code</a>
              <a href="https://utility-app-nine.vercel.app/" target="_blank" className="border-2 border-purple-600 w-[104px] flex items-center justify-center p-2 hover:scale-105 transition-all ease-in-out duration-300  rounded-full  text-white bg-purple-600 font-semibold text-right text-xs">Demo Link</a>
            </div>
          </div>
