            ...
            <div className="flex sm:gap-x-[10%] md:gap-x-[5%] lg:gap-x-[2.5%] flex-wrap   gap-y-20 items-stretch">
                ...
                {projects.map((project) => <div
                    ...
                    <div className="flex items-center justify-between px-2 pt-2 mt-2 mb-2">
                        ...
                        <a href={project.demoLink} target="_blank" className="border-2 border-purple-600 w-[104px] flex items-center justify-center p-2 hover:scale-105 transition-all ease-in-out duration-300  rounded-full  text-white bg-purple-600 font-semibold text-right text-xs">Demo Link</a>
                    </div>
                </div>)}
